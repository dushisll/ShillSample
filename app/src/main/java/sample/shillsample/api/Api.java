...
import sample.shillsample.utils.NetWorkUtils;
...
public class Api {
    ...
    private Api(int hostType) {
        ...
        //缓存
        File cacheFile = new File(BaseApp.getApplication().getCacheDir(), "cache");
    ...
    public static String getCacheControl() {
        return NetWorkUtils.isNetConnected(BaseApp.getApplication()) ? CACHE_CONTROL_AGE : CACHE_CONTROL_CACHE;
    }
    ...
    private final Interceptor mRewriteCacheControlInterceptor = new Interceptor() {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            if (!NetWorkUtils.isNetConnected(BaseApp.getApplication())) {
